...
| 3 | Charged-hadron mom. res. **ATLAS** ($a$,$b$) | all | 0.06–0.25 / 1.3–3.1e-3 | 0.015–0.040 / 3.9–9.0e-4 | Run-2: 1603.05598 §8.2 + 2012.00578 Fig. 2 (form 1404.4562) | ~3× pessimistic. **Run-2 corroborates.** Charged hadrons are ID-only → ID slope $b$≈3.9e-4 used (not combined-muon $b$≈1e-4) |
