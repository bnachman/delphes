...
\begin{figure}[h]
\centering
\includegraphics[width=0.49\textwidth]{aux_trkeff_overlay.pdf}\hfill
\includegraphics[width=0.49\textwidth]{aux_momres_overlay.pdf}
\caption{ATLAS charged-hadron tracking blocks (overlay on digitized points, source
figures cited). Left: tracking efficiency vs.\ $\eta$, ATL-PHYS-PUB-2015-051
Fig.~1a. Right: track momentum resolution vs.\ $\eta$, PERF-2015-10 figaux\_11a.
Remaining blocks (electron/muon/photon identification) are added
to this appendix as their overlays are produced.}
